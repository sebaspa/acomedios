...
function acomedios_styles_scripts()
{
  ...
  if ( is_page( '16' ) )
  {
    ...
    wp_enqueue_style('lightbox-css'   , get_template_directory_uri() . '/css/lightbox.min.css', array(), VERSION);
    wp_enqueue_script('lightbox'  , "https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.8.2/js/lightbox.min.js" , array('jquery'), '2.8.2' , true );
    wp_enqueue_script('lazyload'  , "https://cdn.jsdelivr.net/jquery.lazyload/1.8.4/jquery.lazyload.js"         , array('jquery'), '1.8.4' , true );
  }
