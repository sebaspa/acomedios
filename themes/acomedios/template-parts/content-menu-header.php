  <nav class="menu <?=$pagename;?>">
    <ul class="menu_items">
      <li><a class="<?= (( $pagename==NULL )? 'active' : '') ; ?>" href="<?= site_url(); ?>">Acomedios</a></li>
      <li><a class="<?= (( $pagename=='servicios' )? 'active' : '') ; ?>" href="<?= site_url('servicios'); ?>">Servicios</a></li>
      <li><a class="<?= (( $pagename=='herramientas' )? 'active' : '') ; ?>" href="<?= site_url('herramientas'); ?>">Herramientas</a></li>
      <li class="menu__logo">
        <a href="<?= site_url(); ?>">
          <img class="logo" src="<?= get_template_directory_uri()."/images/logo-menu.png"; ?>" alt="Logo">
        </a>
      </li>
      <li><a class="<?= (( $pagename=='personas-reales' )? 'active' : '') ; ?>" href="<?= site_url('personas-reales'); ?>">Personas Reales</a></li>
      <li style="display:none;"><a class="<?= (( $pagename=='vistete-aco' )? 'active' : '') ; ?>" href="<?= site_url('vistete-aco'); ?>">Vístete ACO</a></li>
      <li><a class="<?= (( $pagename=='unete-al-parche' )? 'active' : '') ; ?>" href="<?= site_url('unete-al-parche'); ?>">Únete al parche</a></li>
      <li><a class="<?= (( $pagename=='contactenos' )? 'active' : '') ; ?>" href="<?= site_url('contactenos'); ?>">Contáctanos</a></li>
     <!--  <li class="search-bar">
